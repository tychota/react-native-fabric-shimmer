...
- [`30dd050`](https://github.com/tychota/react-native-fabric-shimmer/commit/30dd050fc5ee81dbb794611979a81eed3bccb9c9) Thanks [@tychota](https://github.com/tychota)! - Two changes shipping together: a small but breaking API refactor on `<Bone>` for React Compiler memoization, plus a refresh of the default bone visuals.
